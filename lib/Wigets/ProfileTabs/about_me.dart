  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      Padding(
        ...
        child: Text('AboutMe' ,style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
      ),
      SizedBox(height:  10,),
      Container(
        ...
        height: 50,
        width: double.infinity,
        child: Text('Iam a front end developer with almost 1 year experiance in web and app development'),
        ),
